module Validators
  class LocgenresLd4lCacheValidator < AuthorityValidatorService
    AUTHORITY_NAME = :LOCGENRES_LD4L_CACHE
    SERVICE = LD4L_SERVICE

    TERM_URI = 'http://id.loc.gov/authorities/genreForms/gf2011026141'.freeze
    ...
    SEARCH_QUERY = 'animation'.freeze
    PERSON_QUERY = SEARCH_QUERY
    ORGANIZATION_QUERY = SEARCH_QUERY
    PLACE_QUERY = SEARCH_QUERY
    INTANGIBLE_QUERY = SEARCH_QUERY
    GEOCOORDINATES_QUERY = SEARCH_QUERY
