module Validators
  class LocsubjectsLd4lCacheValidator < AuthorityValidatorService
    AUTHORITY_NAME = :LOCSUBJECTS_LD4L_CACHE
    SERVICE = LD4L_SERVICE

    TERM_URI = 'http://id.loc.gov/authorities/subjects/sh2003008312'.freeze
